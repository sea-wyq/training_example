...
if __name__ == '__main__':
    ...
    parser.add_argument('-lb', '--list_buckets', help='List all buckets.', action='store_true',default=False)
    parser.add_argument('-lo', '--list_objects', help='List all objects in the specified bucket.',default="mnist")
    parser.add_argument('-eb', '--empty_bucket', help='Remove all objects in the specified bucket.',default="mnist")
    parser.add_argument('-load', '--load_bucket', help='Load the MNIST dataset into the specified bucket.',default="mnist")
    parser.add_argument('-train', '--train', help='Train model.', action='store_true',default=True)
    parser.add_argument('-lt', '--loader_type', help='Type of loader to use for loading training and test sets (file, list, full, map, or s3map).',default="s3map")
