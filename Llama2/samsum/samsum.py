...
SAMSUM_PATH = "/data/LLAMA1/samsum"
...
class Samsum(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        if os.environ.get('SAMSUM_PATH') is not None:
            path = dl_manager.download(os.environ.get('SAMSUM_PATH') + "/data/corpus.7z") 
        else:
            path = dl_manager.download(SAMSUM_PATH+ "/data/corpus.7z")
        return [
