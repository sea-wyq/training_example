...
python finetuning.py --use_peft --peft_method lora --quantization --use_fp16 --model_name $TASKDATAPATH/Llama-2-7b-hf --output_dir /output/llama2/llama2/output --batch_size_training 1
